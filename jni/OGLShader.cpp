...
GLuint OGLShader::CreateShader(const char* fragPath, const char* vertPath)
{
...
GLuint OGLShader::ReadShaderFile(const char* path, GLenum type)
{
	long lenght;
	char *buffer;
...
GLuint OGLShader::CreateProgram(GLuint VS, GLuint PS)
{
...
//--------------------------------------------------------------------------------------
bool OGLShader::FrmLinkShaderProgram( GLuint Program )
{
